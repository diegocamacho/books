<?
$sql="SELECT books_proveedores.*, books_empresas.empresa FROM books_proveedores 
LEFT JOIN books_empresas ON books_empresas.id_empresa=books_proveedores.id_empresa
...
<!--Formulario -->
		<form id="frm_guarda" class="form-horizontal">
			...
			<div class="form-group">
				<label for="nombre" class="col-md-3 control-label">Proveedor</label>
				<div class="col-md-9">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="text" maxlength="64" class="form-control dat" name="representante" autocomplete="off">
				</div>
			</div>
...
<!--Formulario -->
		<form id="frm_edita" class="form-horizontal">
			...
			<div class="form-group">
				<label for="nombre" class="col-md-3 control-label">Representante</label>
				<div class="col-md-9">
					<input type="text" maxlength="64" class="form-control dat" name="representante" id="representante" autocomplete="off">
				</div>
			</div>
...
$(function(){
	...
	$(document).on('click', '[data-id]', function () {
	    ...
	    $.getJSON('data/proveedor.php', {id:data_id} ,function(data) {
			console.log(data);
