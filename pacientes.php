<?
$sql="SELECT canales.canal, pacientes.* FROM pacientes 
LEFT JOIN canales ON canales.id_canal=pacientes.id_canal
WHERE tipo=1 AND pacientes.activo=1 ORDER BY nombre ASC";
$q=mysql_query($sql);
$pacientes = array();
			...
			<div class="modal-body">
				...
				<form id="frm_agenda" class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group date form_meridian_datetime" data-date="<?=$fecha_actual?>T<?=$hora_actual?>Z">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group date form_meridian_datetime_2" data-date="<?=$fecha_actual?>T<?=$hora_actual?>Z">
                                <input type="text" size="16" class="form-control">
                                <span class="input-group-btn">
                                    <button class="btn default date-reset" type="button">
                                        <i class="fa fa-times"></i>
