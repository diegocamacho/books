...
$sq=@mysql_query("INSERT INTO consultas (id_cita,id_paciente,id_clinica,id_usuario,fecha_hora,observaciones)VALUES('$id_cita','$id_paciente','$id_clinica','$s_id_usuario','$fechahora','$observaciones')");
if(!$sq) $error = true;
...
if($id_cita):
	...
	$referencia="Ingreso por consulta del paciente: ".nombre." atendido por ".$s_nombre;
...
function imprimirConsulta($id_consulta,$metodo, $codigo, $factura = 1){
	...
	$sql = "
	SELECT consultas.fecha_hora,clinicas.clinica, usuarios.nombre
	FROM consultas
