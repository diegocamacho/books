...
$sql="SELECT usuarios.nombre,consultas.*,clinicas.clinica, citas.*, citas.fecha_hora AS fecha_cita, consultas.fecha_hora AS fecha_consulta, consultas.observaciones AS mensaje FROM citas 
...
WHERE citas.id_paciente=$id_paciente ORDER BY citas.fecha_hora DESC";
$q=mysql_query($sql);
$citas = array();
while($datos=mysql_fetch_object($q)):
	$citas[] = $datos;
