<?
$sql="SELECT books_empresas.empresa, books_cuentas.* FROM books_cuentas 
JOIN books_empresas ON books_empresas.id_empresa=books_cuentas.id_empresa
WHERE books_empresas.activo=1
ORDER BY empresa,tipo_cuenta ASC";
$q=mysql_query($sql);
...
$(function(){
	...
	$(document).on('click', '[data-id]', function () {
		...
		$.getJSON('data/cuentas.php', {id:data_id} ,function(data) {
			console.log(data);
			$('#nombre').val(data.alias);
